...
| `shape` | Sequence of integers/`None` or `Expression` | Per-dimension sizes; `None` marks a variable dimension | Required |
...
| `dtype` | Vane `DuckDBPyType` | `tensor_array` element type | Required |
