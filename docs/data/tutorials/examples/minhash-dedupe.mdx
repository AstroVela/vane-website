...
The default configuration uses 64 hash values, five-word shingles, and seed 42. The UDF runs locally by default, but the same schema can be scheduled with a Ray task or actor backend.
