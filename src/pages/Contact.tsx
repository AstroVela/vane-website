...
const CONTACT_ROUTES: Array<{
...
}> = [
  {
    ...
    copyZh: '和 Vane 团队一起梳理一个真实多模态工作负载。',
  ...
  },
  {
    ...
    copyZh: '咨询 SQL、Python UDF、Ray 执行或部署形态。',
  ...
  },
  {
    ...
    copyZh: '加入 Discord 获取项目更新，并更快进行非正式提问。',
    href: DISCORD_URL,
    icon: 'retrieval',
  },
]
...
export default function Contact() {
  ...
  const copy = pickLocale(
    ...
    {
      title: '联系 Vane 团队',
      description: '联系 Vane 团队，讨论多模态数据流水线、企业 agent 数据基础设施、训练数据工作流、合作和技术问题。',
      ogDescription: '告诉我们你正在用多模态数据构建什么。我们会尽量在 48 小时内回复。',
      eyebrow: '联系',
      heading: '和 Vane 工程团队聊聊',
      lead: '告诉我们你的数据形态、规模、当前技术栈和目标场景。我们会转给合适的工程师，并尽量在 48 小时内回复。',
      ...
      interest: '关注方向',
      select: '请选择',
      placeholder: '工作负载、数据形态、规模、当前技术栈、时间计划...',
      send: '发送消息',
      submitted: '邮件草稿已打开，你可以从邮件客户端发送。',
      routes: '常用途径',
      routesTitle: '按问题类型选择入口',
      open: '打开',
      subjectPrefix: 'Vane contact',
      general: '一般咨询',
      bodyLabels: {
